# 1 "c:\\users\\ura\\desktop\\lr_scripts\\script1\\\\combined_script1.c"
...
# 1 "c:\\users\\ura\\desktop\\lr_scripts\\script1\\\\combined_script1.c" 2
...
# 2 "c:\\users\\ura\\desktop\\lr_scripts\\script1\\\\combined_script1.c" 2
...
# 3 "c:\\users\\ura\\desktop\\lr_scripts\\script1\\\\combined_script1.c" 2
...
# 4 "c:\\users\\ura\\desktop\\lr_scripts\\script1\\\\combined_script1.c" 2
...
# 5 "c:\\users\\ura\\desktop\\lr_scripts\\script1\\\\combined_script1.c" 2
...
login()
{
	...
	lr_end_transaction("login_started_T001", 2);
	...
	{
		lr_end_transaction("login_SignIn_T002", 2);
	}
	else
	{
		lr_end_transaction("login_SignIn_T002", 1);
	}
	...
	{
		lr_end_transaction("login_SignOut_T003", 2);
	}
	else
	{
		lr_end_transaction("login_SignOut_T003", 1);
	}
...
# 6 "c:\\users\\ura\\desktop\\lr_scripts\\script1\\\\combined_script1.c" 2
...
# 7 "c:\\users\\ura\\desktop\\lr_scripts\\script1\\\\combined_script1.c" 2
